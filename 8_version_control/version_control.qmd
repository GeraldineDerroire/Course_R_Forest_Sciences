...
* [edit the file manually but removing the version you don't want to keep (or writting an alternative version)]{style="font-size: 30px"}
...
[*You can know solve this conflict!*]{style="font-size: 30px"}
...
::: nonincremental
* [create to do list]{style="font-size: 30px"}
...
[You can select the branch you want to work on:]{style="font-size: 30px"}
