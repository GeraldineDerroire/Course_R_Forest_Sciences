...
*BCI*.
The dataset is a floristic table.
It has a row per plot and a column per species.
The values are the number of trees of a given species in a given plot.
...
* Check that the dimensions of this new table are correct (try to do it using a test).
