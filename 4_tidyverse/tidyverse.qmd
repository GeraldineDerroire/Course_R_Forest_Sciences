...
::: notes
Here a lot of values are the same as there are quite often just one species per genus

but let's scroll and look at Couepia
...
```
::: notes
Here the beginning of the code is the same, we just filter the genus Licania
:::
...
fct_lump => group levels base on a criteria: ex all the levels that have a too small occurences groupes together
:::
