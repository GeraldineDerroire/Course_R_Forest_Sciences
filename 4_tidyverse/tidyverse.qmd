...
::: notes
The number of rows can be specify or we can specify a proportion of rows (here 10%, we had 45 species)
:::
...
we find the chawari from the previous session
:::
...
note that this is not needed to make the package tidy
:::
