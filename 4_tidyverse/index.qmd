...
::: {.column width="40%"}
[The [full_join]{style="color:indianred;"} keeps all the rows in traits_sub and sp_com_sub]{.fragment}
:::
:::::
...
::: notes
last session and today, we have seen how to manipulate dity data, but let's now see what to do when the data are not tidy
:::
...
[case_when]{style="color:indianred;"} from the package [dplyr]{style="color:indianred;"} generalises if else to allow several conditions:
