...
# Functional programmingwith the [tidyverse]{style="color:indianred;"}
...
[[[across]{style="color:indianred;"} takes 2 arguments: the definition of he columns to transform, and the function to apply:]{style="font-size: 30px"}]{.fragment}
...
[We can also use [where]{style="color:indianred;"} to specify the columns:]{style="font-size: 30px"}
...
## Names of the columns created by [across]{style="color:indianred;"} withing [mutate]{style="color:indianred;"} {.smaller}
...
::: fragment 
[We would like to add a random draw taken between Min and Max, for each row:]{style="font-size: 30px"}
...
[[🥴 This didn't work... [mutate]{style="color:indianred;"} was applied on all rows using Min and Max of the first row... ]{style="font-size: 30px"}]{.fragment}
