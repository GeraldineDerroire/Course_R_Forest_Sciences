...
* Wickham H., Cetinkaya-Rundel M., Grolemund G. *R for Data Science*  - Chapter on functions [in English](https://r4ds.had.co.nz/functions.html) and [in Portuguese](https://pt.r4ds.hadley.nz/functions.html){preview-link="false"}

* Wickham H. *Advanced R*  - Chapter on functions [in English](https://adv-r.hadley.nz/functions.html){preview-link="false"}
