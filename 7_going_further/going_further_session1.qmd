...
[[seq_along]{style="color:indianred;"} is a variant of [seq]{style="color:indianred;"} that creates sequences of a length equal to the length of its arguments:]{style="font-size: 30px"}
...
Objects created in a function are **local objects**, they don't exist outside of the function.
