...
these will be useful if you need to simulate data (for example for predictions using a model) + and for loops that we will see in the next session
:::
...
Let's add an **argument** that we call *name* to our function, and use it in the code in the **body** of the function:
...
**Step 3: develop the code... and add new steps if needed**
...
* add the instruction *function*

* put the argument in *()* and the code in *{}*
...
⚠️ Remember that to be able to use the function, 
