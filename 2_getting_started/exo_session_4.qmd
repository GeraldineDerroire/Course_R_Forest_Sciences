...
Download the two data set [here](https://geraldinederroire.github.io/Course_R_Forest_Sciences/3_manip_data/data/BCI.env_semicol.csv){preview-link="false"} and here [here](https://geraldinederroire.github.io/Course_R_Forest_Sciences/3_manip_data/data/BCI_env.csv){preview-link="false"} and store them in your raw data folder.
