---
title: "Exercices on session *Getting started with R (2/2)*"
format:
  pdf
execute:
  echo: false
...
* Calculate the basal area of a tree of diameter 25 cm (the basal area is the area of a circle that has the diameter of the consider tree), in m^2^
