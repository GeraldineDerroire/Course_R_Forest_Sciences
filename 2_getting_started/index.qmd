...
[We can see the structure of the matrix using ]{.fragment}[str]{style="color:indianred;"}
...
[We get the sum of each column using ]{.fragment}[colSums]{style="color:indianred;"} :
...
[We can see the structure of the list using ]{.fragment}[str:]{style="color:indianred;"}
...
[We use ]{.fragment}[\|]{style="color:indianred;"} to test if **at least** one condition is satisfied:
...
<!-- Cours Juba, cours Mélaine, cours Eric-->

```{=html}
<!--
## Resources

voir si help on rbase

et les cours en portugais (video of prof de Ecology et livre en portugais)
```
