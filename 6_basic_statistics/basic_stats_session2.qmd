...
[We now want to model D as a function of the family:]{style="font-size: 30px"} <!-- TO DO : check the equation-->
...
::: notes
explain for dist and clim, and show the equation on the blackboard
:::
:::
:::::
