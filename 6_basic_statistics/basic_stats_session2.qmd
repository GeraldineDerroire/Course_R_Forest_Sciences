...
we get the K: number of paramaters
...
[[💡 See here for a detailed explanation of linear mixed model.]{style="font-size: 30px"}]{.fragment}

<!-- TO DO add a link here -->


## What if the data are not normally distributed?

dire que certaines données ne sont pas normalement distribuées et donc normale pas possible

* données de comptes => Poisson

* données de succès/échec

... voir mes slides non -utilisées
...
voir Marchand 
=> expliquer link function, distribution, et formule
