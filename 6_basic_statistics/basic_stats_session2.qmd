...
quand transfo de données: from package ggeffects

```{r}
# Get predictions back on original scale
preds <- ggeffects::ggpredict(mod_dh_2, terms = "D")  

# check with the D usef for predict don't go above 80cm
# for prediction interval, apparently add interval = "prediction" but TO CHECK
