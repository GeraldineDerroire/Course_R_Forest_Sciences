---
title: "Exercices on session *Statistics with R - Distributions and hypothesis*"
format:
  pdf
execute:
  echo: false 
...
```{r}
questionr::chisq.residuals(dt_deptA, std = TRUE)
...
# Note that the name of the vector of result is not correct
```
...
# big confidence interval (few data points...)
```
