...
::: notes
why did I asked you to install it in the tutorial then ? because the updates of quarto are only made available when there is a new version of RStudio...
:::
...
*The **Visual editor**  is convenient for beginners.*
...
## Source editor {.smaller}

You can view and edit the plain Markdown document in the **Source editor**:

![](source.png){fig-align="center"}

*The **Source editor** gives full control and is generally preferred for programming and version control*
...
[The packages [gt](https://gt.rstudio.com/) and [flextable](https://ardata-fr.github.io/flextable-book/) proposes additional formatting options.]{style="font-size: 30px"}
