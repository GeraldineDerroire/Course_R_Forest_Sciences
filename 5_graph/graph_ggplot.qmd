...
# [ggspatial]{style="color:indianred;"} ggplot extension for maps

R can be used as a GIS software... but this is besides the objectives of this module.

The package [ggspatial]{style="color:indianred;"} can be used to make maps using geographical layers that can be created in R or imported from a GIS software:
