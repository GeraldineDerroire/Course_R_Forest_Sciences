...
- **Discipline** *Transferência de informações florestais* (Code: PPGEFL0418)
- **Credits** 4
...
and the course material is online [here](https://geraldinederroire.github.io/Course_R_Forest_Sciences/){preview-link="false"}.
